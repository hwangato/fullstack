(function () {
  ...
  function observe (obj) {
    for (var key in obj) {
	  ...
	  //defineReactive(obj,"message",'Hello world')
	  //defineReactive(obj,"isShow",true)
  }
  ...
  function Watcher (vm, expOrFn, cb) {
    ...
    this.depIds = [];
    this.value = this.get();
	//console.log(this.getter,this.cb,this.depIds,this.value);
  }
  ...
  function initData (vm) {
    ...
    var keys = Object.keys(data);// array return ["message","isShow"]
    //console.log(keys);
	var i = keys.length
